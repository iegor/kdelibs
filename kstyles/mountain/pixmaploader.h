...
namespace Mountain {
  class PixmapLoader {
    ...
    private:
      ...
      struct MountainCacheEntry {
          ...
          MountainCacheEntry(int id, const QColor& color, const QColor& bg, bool disabled,
          ...
          bool operator == (const MountainCacheEntry& other) {
      ...
      QIntCache <MountainCacheEntry>  m_pixmapCache;
  ...
  class TilePainter {
    ...
    protected:
      ...
      the IDs to pixmaps, and mountainrc.h, which provides nice symbolic constants for base IDs.
      ...
      cases by splitting the widget identity from tile identity (as there are many
  ...
  class SpinBoxPainter : public TilePainter {
    public:
      SpinBoxPainter() : TilePainter(mountain_spinbox) {
        colMde[0] = colMde[2] = Fixed;
        colMde[1] = Scaled;
